    ...
    return [
        gtypes.FunctionDeclaration(
            ...
            description=(
                ...
                "2. Try to keep every band member playing. If there are more members than parts, "
                "put the extras on a choir/vocal track (the only kind you may double). If there "
                "is nothing vocal to double, let an extra member sit out, do NOT double a normal "
                "instrument just to keep someone busy.\n"
                "3. ONLY choir and vocal voices may be doubled, a choir, 'aah', 'ooh', voice or "
                "vox track. Put two or three members on those to build a rich, full, centered "
                "choir, do it freely by default.\n"
                "4. Every other instrument stays UNIQUE, exactly one member each, including drums, "
                "bass, lead, strings, brass, pad, organ and every melodic or plucked part. "
                "Doubling a normal instrument flams and sounds weird, so never do it.\n"
                        ...
                        items=S(
                            ...
                            properties={
                                ...
                                "members": S(
                                    type=T.ARRAY,
                                    description=(
                                        "Names of the band members who play this track. Use "
                                        "exactly ONE member for every normal instrument (drums, "
                                        "bass, lead, strings, brass, pad, organ, plucked, melodic), "
                                        "doubling those sounds weird. ONLY choir and vocal voices "
                                        "(choir, 'aah', 'ooh', voice, vox) may have two or three "
                                        "members to thicken them. Spread parts so members are used "
                                        "where you can."
                                    ),
...
def _system_instruction(host_name: str) -> str:
    return (
        ...
        "- Try to keep every member playing. More members than parts means put the extras on a "
        "choir/vocal track, the only kind you may double. If there is nothing vocal to double, "
        "let an extra member sit out rather than doubling a normal instrument.\n"
        "- ONLY choir and vocal voices may be doubled, a choir, 'aah', 'ooh', voice or vox track. "
        "Put two or three members on those to build a rich, full, centered choir, do it freely by "
        "default.\n"
        "- Every other instrument stays unique, exactly one member each, drums, bass, lead, "
        "strings, brass, pad, organ and every melodic or plucked part. Doubling a normal "
        "instrument flams and sounds weird, so never do it.\n"
