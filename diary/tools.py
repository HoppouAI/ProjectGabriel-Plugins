        ...
        return [
            types.FunctionDeclaration(
                ...
                description=(
                    ...
                    "references something you might have written about. Your most recent days are "
                    "already in your prompt, so reach for this to pull up OLDER days or the full text "
                    "of a day you only half remember. Lean toward checking rather than guessing: if "
                    "you're about to say you don't recall something, read your diary first. Also helpful "
                    "when the regular memory tools come up empty but you suspect there's narrative "
            ...
            types.FunctionDeclaration(
                ...
                description=(
                    ...
                    "**Invocation Condition:** The moment someone brings up a person, place, event, or "
                    "inside joke you don't have fresh context on, search your diary BEFORE telling them "
                    "you don't remember. Don't claim you forgot something without checking first, a "
                    "quick search is cheap and you've probably written about it. Useful for queries like "
                    "'do you remember X', 'when did you last hang out with X', or 'tell me about that "
                    "time with Y'.\n"
